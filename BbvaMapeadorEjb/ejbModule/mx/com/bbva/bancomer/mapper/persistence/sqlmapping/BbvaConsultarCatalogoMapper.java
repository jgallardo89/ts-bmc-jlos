 ...
 * Razon: Creacion        
 * Version: 1.0.0
 * Nombre de clase: BbvaConsultarCatalogoMapper.java
 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
/**
 * The Interface BbvaConsultarCatalogoMapper.
 */
public interface BbvaConsultarCatalogoMapper 
	{
	
	/**
	 * Read bbva estatus clave vo.
	 *
...
//	            "order by BY TGM534_ST_OBJETO.NB_TABLA" )
	...
	/**
	 * Read by estatus clave bbva estatus vo.
	 *
	 * @param bbvaEstatusVO the bbva estatus vo
	 * @return the java.util. list
	 */
	@Select("select	TGM534_ST_OBJETO.CD_ST_OBJETO cdStObjeto," +
		           "TGM534_ST_OBJETO.CD_ST_CLAVE  cdStClave,"  +
...
//	            "order by BY TGM534_ST_OBJETO.NB_TABLA" )
	...
	/**
	 * Read by estatus pantalla bbva estatus vo.
	 *
	 * @param bbvaEstatusVO the bbva estatus vo
	 * @return the java.util. list
	 */
...
//	            "order by BY TGM534_ST_OBJETO.NB_TABLA" )
	...
	/**
	 * Read by estatus pantalla clave bbva estatus vo.
	 *
	 * @param bbvaEstatusVO the bbva estatus vo
	 * @return the java.util. list
	 */
