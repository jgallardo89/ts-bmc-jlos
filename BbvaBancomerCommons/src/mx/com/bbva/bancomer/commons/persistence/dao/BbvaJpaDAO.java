 ...
 * Razon: Creacion        
 * Version: 1.0.0
 * Nombre de clase: BbvaJpaDAO.java
 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
/**
 * The Class BbvaJpaDAO.
 */
@SuppressWarnings("deprecation")
public 	class 		BbvaJpaDAO 
	...
	//	Privados|estaticos
	/** The Constant logger. */
	private static final org.apache.log4j.Logger 	logger			 = Logger.getLogger( BbvaJpaDAO.class );
	...
	throws mx.com.bbva.bancomer.commons.exception.BbvaDataBaseException
		...
		try {
			...
			{
			throw new BbvaDataBaseException( "9905|BbvaJpaDAO|queryForList", exception );
			}
		}
	/* (non-Javadoc)
	...
	throws mx.com.bbva.bancomer.commons.exception.BbvaDataBaseException
		...
		try {
			...
			{
			throw new BbvaDataBaseException( "9905|BbvaJpaDAO|queryForObject", exception );
			}
		}
	/* (non-Javadoc)
