 ...
 * Razon: Creacion        
 * Version: 1.0.0
 * Nombre de clase: BbvaIBatisDAO.java
 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
/**
 * The Class BbvaIBatisDAO.
 */
@SuppressWarnings("deprecation")
public 	class 		BbvaIBatisDAO 
	...
	//	Privados|estaticos
	/** The Constant logger. */
	private static final org.apache.log4j.Logger 	logger			 = Logger.getLogger( BbvaIBatisDAO.class );
	...
	throws mx.com.bbva.bancomer.commons.exception.BbvaDataBaseException
		...
		try {
			...
			{
			throw new BbvaDataBaseException( "9902|BbvaIBatisDAO|queryForList", exception );
			}
		}
	/* (non-Javadoc)
	...
	throws mx.com.bbva.bancomer.commons.exception.BbvaDataBaseException
		...
		try {
			...
			{
			throw new BbvaDataBaseException( "9902|BbvaIBatisDAO|queryForObject", exception );
			}
		}
	/* (non-Javadoc)
