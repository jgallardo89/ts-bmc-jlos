...
public interface BbvaConsultarCatalogoMapper 
	...
	//			   "cast( TGM534_ST_OBJETO.NB_TABLA as VARCHAR2(  30 BYTE ) ) nbTabla " +
			    "from MAPEADOR.TGM534_ST_OBJETO order by TGM534_ST_OBJETO.CD_ST_OBJETO" )
	public java.util.List<mx.com.bbva.bancomer.test.model.BbvaEstatusVO> readBbvaEstatusVO( );
	/**
	 * 
	 * @return
	 */
	...
	public java.util.List<mx.com.bbva.bancomer.test.model.BbvaPerfilVO> readBbvaPerfilVO	( );
	/**
	 * 
	 * @return
	 */
	...
	public java.util.List<mx.com.bbva.bancomer.test.model.BbvaUsuarioVO> readBbvaUsuarioVO( );
	}