 ...
 * Razon: Creacion        
 * Version: 1.0.0
 * Nombre de clase: BbvaCargarTablaUsuarioDTO.java
 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
/**
 * The Class BbvaCargarTablaUsuarioDTO.
 */
public 	class 	BbvaCargarTablaUsuarioDTO 
		extends	BbvaAbstractDataTransferObject
	{
	//  Atributos     - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	//	Privados|estaticos
	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -3910986312521187753L;
