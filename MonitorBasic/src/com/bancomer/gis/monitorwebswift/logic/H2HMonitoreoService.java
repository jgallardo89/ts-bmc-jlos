 ...
 *
 * Archivo: H2HMonitoreoService.java.
 *
 * Creado: 05/10/2010.
 *
 ...
 * @author XM07355
 */
public interface H2HMonitoreoService {
	/**
	 ...
	 */
	List obtenerArchivosProcesadosH2HXPagina(String fechaInicio, String fechaFin, int pagina, String bicRec, String contrato, String folio, String archivoRecibido,int tamPagina, 
			 boolean descending);
	 ...
	 * @return
	 */
	int obtenerNumArchivosProcesadosH2H(String fechaInicio, String fechaFin, String bicRec, String contrato, String folio, String archivoRecibido);
