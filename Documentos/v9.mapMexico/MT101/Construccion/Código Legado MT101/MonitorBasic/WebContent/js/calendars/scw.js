...
//******************************************************************************
    ...
    function scwSetDefaultLanguage()
        {try
            ...
            {// English
             scwToday               = 'Hoy:';
             scwClear               = 'Limpiar';
             scwDrag                = 'Clic para cortar';
             scwArrMonthNames       = ['Ene','Feb','Mar','Abr','May','Jun',
                                       'Jul','Ago','Sep','Oct','Nov','Dic'];
             scwArrWeekInits        = ['D','L','M','m','J','V','S'];
             scwInvalidDateMsg      = 'La fecha es invalida.\n';
             scwOutOfRangeMsg       = 'La fecha esta fuera de rango.';
             scwDoesNotExistMsg     = 'la fecha no existe.';
             scwInvalidAlert        = ['Fecha invalida (',') ignored.'];
             scwDateDisablingError  = ['Error ',' no es un obejto fecha.'];
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            'select.scwHead             {'       						+
							            'BORDER-RIGHT: #039 none;'      +
							            'BORDER-TOP: #039 none;'	    +
							            'BORDER-LEFT: #039 none;' 	    +
							            'COLOR: #055A78;' 	      			+
							            'BORDER-BOTTOM: #039 none;' 	+
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #D3E9EB;}'  +
            '/* Drag Handle */'                                         +
            'td.scwDrag                 {background-color:  #CCCCCC;'   +
                                        'color:             #CCCCFF;}'  +
            '/* Week number heading */'                                 +
            ...
            'td.scwWeekNo               {background-color:  #FFFFFF;'   +
                                        'color:             rgb(117, 145, 221);}'  +
            '/* Enabled Days */'                                        +
            '/* Week Day */'                                            +
            'td.scwCells                {background-color:  #9ac2e5;'   +
                                        'color:             #055A78;}'  +
            '/* Day matching the input date */'                         +
            'td.scwInputDate            {background-color:  #9ac2e5;'   +
                                        'color:             #055A78; font-size:8pt;}'  +
            '/* Weekend Day */'                                         +
            'td.scwCellsWeekend         {background-color:  #9ac2e5;'   +
                                        'color:             #000000;}'  +
            '/* Day outside the current month */'                       +
            'td.scwCellsExMonth         {background-color:  #cccccc;'   +
                                        'color:             #666666;}'  +
            '/* Today selector */'                                      +
            'td.scwNow                  {background-color:  #9ac2e5;'   +
                                        'color:             #055A78;}'  +
            '/* Clear Button */'                                        +
            ...
            '/* Active cells */'                                        +
            'td.scwCells:hover,'                                        +
            'td.scwCellsHover           {background-color:  rgb(254,218,96) !important;'   +
                                        'cursor:            pointer;'   +
                                        'color:             #000000;}'  +
            '/* Day matching the input date */'                         +
            'td.scwInputDate:hover,'                                    +
            'td.scwInputDateHover       {background-color:  rgb(254,218,96) !important;'   +
                                        'cursor:            pointer;'   +
                                        'color:             #000000; font-size:8pt;}'  +
            '/* Weekend cells */'                                       +
            'td.scwCellsWeekend:hover,'                                 +
            'td.scwCellsWeekendHover    {background-color:  rgb(254,218,96) !important;'   +
                                        'cursor:            pointer;'   +
                                        'color:             #000000;}'  +
            '/* Day outside the current month */'                       +
            'td.scwCellsExMonth:hover,'                                 +
            'td.scwCellsExMonthHover    {background-color:  rgb(254,218,96) !important;'   +
                                        'cursor:            pointer;'   +
                                        'color:             #000000;}'  +
            '/* Today selector */'                                      +
            'td.scwNow:hover,'                                          +
            'td.scwNowHover             {background-color:  rgb(254,218,96) !important; color:             #000000;'   +
                                        'cursor:            pointer;}'  +
            '/* Disabled cells */'                                      +
            '/* Week Day */'                                            +
            '/* Day matching the input date */'                         +
            'td.scwInputDateDisabled    {background-color:  #FFFF00;'  +
                                        'color:             #000000;}'  +
            'td.scwCellsDisabled        {background-color:  #FFFF00;'   +
                                        'color:             #000000;}'  +
            '/* Weekend Day */'                                         +
            'td.scwCellsWeekendDisabled {background-color:  #FFFF00;'   +
                                        'color:             #000000;}'  +
            '/* Day outside the current month */'                       +
            'td.scwCellsExMonthDisabled {background-color:  #FFFF00;'   +
                                        'color:             #000000;}'  +
                         ...
                         if (scwCols.nodeType==1 && scwCols.tagName=='TD')
                            {scwRows.childNodes[j].innerHTML=
                             ...
                             if (scwDisabled ||
                                ...
                                {scwRows.childNodes[j].onclick = scwCellOutput;//********************* esto debes ponerlo a null si es que no quieres
                                //que te regrese nada cuando le das click a un dia desabilitado, pero como nosotros colo queremos cambiar de 
                                //desabilitados a marcados lo cambiamos de esto 
                                //***************************************************
